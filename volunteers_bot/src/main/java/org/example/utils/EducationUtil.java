...
public class EducationUtil {
    public static final String ANOTHER_ANSWER = "Другое";
    public static final List<String> SCHOOL_LIST = List.of("Школа №1", "Школа №2", "Школа №3", "Школа №4", "Школа №5", "Школа №5", "Школа №6", "Школа №7", "Школа №8", "Школа №9", "Школа №10", "Школа №11", ANOTHER_ANSWER);
    public static final List<String> UNIVERSITY_LIST = List.of("Институт №1", "Институт №2", "Институт №3", "Институт №4", "Институт №5", "Институт №6", "Институт №7", "Институт №8", "Институт №9", "Институт №10", "Институт №11", ANOTHER_ANSWER);
    public static final List<String> SECONDARY_PROFESIONAL_LIST = List.of("ПТУ №1", "ПТУ №2", "ПТУ №3", "ПТУ №4", "ПТУ №5", "ПТУ №6", "ПТУ №7", "ПТУ №8", "ПТУ №9", "ПТУ №10", "ПТУ №11", ANOTHER_ANSWER);
